...
// DEFINE DIRECTORYS
define('INCLUDE_PATH', 'https://www.eugeniomariz.com.br/');
...
// CONNECTING DB
define('HT', 'mysql.eugeniomariz.com.br');
define('NAMEDB', 'eugeniomariz');
define('USR', 'eugeniomariz');
define('PSW', 'Jr@way6HUxjm3yg');
