    ...
    if (!$erro) {
        ...
        if ($comp->rowCount() == 1) {
            ...
            if (isset($order_id)) {
                ...
                $arr = ['categoria_id' => $categoria_id, 'titulo' => $titulo, 'autor' => $autor, 'conteudo' => $conteudo, 'capa' => $capa, 'slug' => $slug, 'postagem' => $postagem, 'order_id' => 2, 'tabela' => 'tb_painel_admin.noticias'];
            }
            NWS::insert($arr);
